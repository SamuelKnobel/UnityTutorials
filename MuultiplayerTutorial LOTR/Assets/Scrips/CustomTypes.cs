...
namespace Photon.Pun
{
    ...
    internal static class CustomTypes
    {
        ...
        internal static void Register()
        {
            ...
            PhotonPeer.RegisterType(typeof(TestClass), (byte)'T', TestClass.Serialize, TestClass.Deserialize);
            //PhotonPeer.RegisterType(typeof(PlayerSettings), (byte)'P', PlayerSettings.Serialize, PlayerSettings.Deserialize);
            //Debug.Log(PhotonPeer.RegisterType(typeof(PlayerSettings), (byte)'P', PlayerSettings.Serialize, PlayerSettings.Deserialize));
            //PhotonPeer.RegisterType(typeof(Buildings), (byte)'B', Buildings.Serialize, Buildings.Deserialize);
            //PhotonPeer.RegisterType(typeof(Race), (byte)'R', Race.Serialize, Race.Deserialize);
        }
